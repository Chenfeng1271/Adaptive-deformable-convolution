...
class _DenseAsppBlock(nn.Module):
    ...
    def __init__(self, input_num, num1, num2, dilation_rate, drop_out, bn_start=True,modulation=True):
        ...
        #现deformv2集成代码
        self.deform_conv = DeformConv2d(num1,num2,3,padding=1,modulation=self.modulation)
        #原deformv1代码
    ...
    def forward(self,input):
        ...
        if self.modulation ==True:
            feature1,_ = self.deform_conv(feature)
        else:
...
class DenseASPP(nn.Module):
    def __init__(self,num_features,d_feature0,d_feature1,dropout0,modulation=True):
...
def build_densedspp():
    return DenseASPP(2048,512,128,.1,modulation = True)
